...
const SearchMovie  = (props) => {
  ...
  useEffect(() => {
    api.search.getQueryTVs(props.search, page).then((res) => {
    ...
    <>
      {
        ...
        :
        <Row>
          <ResultsInfo isLoading={isLoading} pageLeng={results.length} results={totalResults}/>
          <Results cat={'tv'} results={results}/>
